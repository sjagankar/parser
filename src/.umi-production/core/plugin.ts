...
import * as Plugin_0 from '/Users/satya/Documents/workspace/apps/parser/src/app.js';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/satya/Documents/workspace/apps/parser/src/app.js',
    },
  ];
}
